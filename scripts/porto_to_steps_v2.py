...
def _mp_init_worker(net_path: str) -> None:
    ...
    _mp_worker_state = (np_local, edges_data, edge_shapes, node_positions, y_min, y_max, spatial_index)
...
def _mp_convert_one(
    ...
    if ts is None:
        return None
    np_local, edges_data, edge_shapes, node_positions, y_min, y_max, spatial_index = _mp_worker_state
