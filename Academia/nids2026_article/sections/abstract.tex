\begin{abstract}
Estimated time of arrival (ETA) is the prediction of how long a trip will take from a given origin to a destination under current and evolving traffic conditions.
It underpins navigation, dispatch, logistics, and traveler information systems: small errors propagate into poor routing, missed connections, and loss of trust in the service.
