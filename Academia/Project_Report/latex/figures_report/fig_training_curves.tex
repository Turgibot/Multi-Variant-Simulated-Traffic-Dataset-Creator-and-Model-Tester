...
\draw[blue, thick] (3.7,0.15) -- (4.2,0.15) node[right] {\scriptsize MAE [s]};
\draw[red!75!black, thick] (5.0,0.15) -- (5.5,0.15) node[right] {\scriptsize RMSE [s]};
\draw[green!50!black, thick, dashed] (6.55,0.15) -- (7.05,0.15) node[right] {\scriptsize MAPE [\%], scaled};
\end{tikzpicture}
\caption{Representative 100-epoch validation curves for the two construction paths. Both curves converge, while the trajectory-conversion path converges later because repaired GPS traces are sparser and noisier than the controlled simulation data.}
