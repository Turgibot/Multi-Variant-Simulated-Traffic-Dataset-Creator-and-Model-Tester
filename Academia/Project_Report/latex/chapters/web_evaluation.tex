...
Trip duration (s), avg.\ / std. & 1\,011 / 416 & 731 / 514 \\
Trip distance (km), avg.\ / std. & 13.07 / 6.42 & 5.82 / 5.10 \\
...
\begin{table}[!htbp]
\caption{Learning validation after 100 epochs: route-aware model vs.\ mean-duration baseline. MAE/RMSE are in seconds; MAPE is in percent.}
...
\toprule
 & & \multicolumn{3}{c}{Route-aware model} & \multicolumn{3}{c}{Mean baseline} \\
\cmidrule(lr){3-5}\cmidrule(lr){6-8}
Data source & $n$ & MAE & RMSE & MAPE & MAE & RMSE & MAPE \\
 & & (s) & (s) & (\%) & (s) & (s) & (\%) \\
\midrule
Simulation & 2\,707 & 44.35 & 106.56 & 17.09 & 260.63 & 325.13 & 127.75 \\
Trajectory conversion & 3\,055 & 51.69 & 120.56 & 20.08 & 282.66 & 352.41 & 138.50 \\
\bottomrule
\end{tabular}
\end{table}
...
Figure~\ref{fig:training_curves} illustrates typical validation behavior over the 100 epochs. The simulation curve descends faster because the simulator exposes dense, regularly sampled, controlled trajectories. The conversion curve reaches a comparable regime later because the learning signal comes from sparse real traces that have passed through repair, segmentation, and route matching.
